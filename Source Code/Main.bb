...
AppTitle "SCP - Futuristic Anomalies v"+ModVersionNumber
...
Global LiquidObj%,MTFObj%,GuardObj%,ClassDObj%,FGuardObj%
...
Function DrawMenu()
	...
	If MenuOpen Then
		...
		ElseIf QuitMSG > 0 Then
			AASetFont Font2
			AAText(x, y-(122-45)*MenuScale, "Leave?",False,True)
			AASetFont Font1
		ElseIf KillTimer >= 0 Then
			AASetFont Font2
			AAText(x, y-(122-45)*MenuScale, "Game Paused",False,True)
			AASetFont Font1
		Else
			AASetFont Font2
		...
		ElseIf AchievementsMenu <= 0 And OptionsMenu > 0 And QuitMSG <= 0 And KillTimer >= 0
			...
			If DrawButton(x+215*MenuScale,y,100*MenuScale,30*MenuScale,"Keys+Binds",False) Then OptionsMenu = 3
...
Function LoadEntities()
	...
	FGuardObj = LoadAnimMesh_Strict("GFX\npcs\femaleguard.b3d") ;female guards
