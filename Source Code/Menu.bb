...
Function UpdateMainMenu()
						...
						If Rand(15)=1 Then 
							Select Rand(13)
								...
								Case 8
									RandomSeed = "SCPF"
								Case 9
									RandomSeed = "wehatescp"
								Case 10
									RandomSeed = "V2N3BR41N"
								Case 11
									RandomSeed = "the"
								Case 12
									RandomSeed = "B4tt1ef0rge"
								Case 13
									RandomSeed = "Rad1c4lS1n1"
							End Select
						Else
							n = Rand(4,8)
							For i = 1 To n
	...
	Else
		...
		Select MainMenuTab
			Case 1 ; New game
				...
				Color(255, 255, 255)
				AASetFont Font2
				AAText(x + width / 2, y + height / 2, "Enter", True, True)
				...
				AAText(x + 20 * MenuScale, y + 110 * MenuScale, "Intro Enabled?")
			...
			Case 2 ;load game
				...
				Color(255, 255, 255)
				AASetFont Font2
				AAText(x + width / 2, y + height / 2, "Load Progress", True, True)
				...
				Else
						...
						If i <= SaveGameAmount Then
							...
							If SaveMSG = "" Then
								If SaveGameVersion(i - 1) <> CompatibleNumber And SaveGameVersion(i - 1) <> "1.3.10" Then
									...
									Color(255, 0, 0)
									AAText(x + 330 * MenuScale, y + 34 * MenuScale, "Insert", True, True)
								Else
									If DrawButton(x + 280 * MenuScale, y + 20 * MenuScale, 100 * MenuScale, 30 * MenuScale, "Insert", False) Then
										LoadEntities()
										LoadAllSounds()
								...
								If DrawButton(x + 400 * MenuScale, y + 20 * MenuScale, 100 * MenuScale, 30 * MenuScale, "Wipe", False) Then
					...
					If SaveMSG <> ""
						...
						RowText("Are you sure you want to wipe this disc?", x + 20 * MenuScale, y + 15 * MenuScale, 400 * MenuScale, 200 * MenuScale)
	...
	AAText 30,GraphicHeight-60,"Futuristic Anomalies v"+ModVersionNumber
	
	Color 255,255,255
	AASetFont ConsoleFont
	AAText 30,GraphicHeight-45,"Developed by "+DevTeamNames
	
	Color 255,255,255
	AASetFont ConsoleFont
	AAText 30,GraphicHeight-30,"Running on SCP: Containment Breach v"+VersionNumber
...
Function UpdateLauncher()
	...
	AppTitle "Futuristic Anomalies Launcher v"+ModVersionNumber
	...
	Repeat
		...
		BorderlessWindowed = DrawTick(360, 220, BorderlessWindowed)

		LauncherEnabled = DrawTick(220, 220, LauncherEnabled)
		...
		Color 255, 255, 255
		Text(390, 220, "Borderless windowed mode",False,False)
